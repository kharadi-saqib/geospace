...
MEMCACHED_LOCATION = os.getenv("MEMCACHED_LOCATION", "127.0.0.1:8000")
...
GEOSERVER_PUBLIC_HOST = os.getenv("GEOSERVER_PUBLIC_HOST", '127.0.0.1')

GEOSERVER_PUBLIC_PORT = os.getenv("GEOSERVER_PUBLIC_PORT", 8000)
