...
#MEDIA_ROOT="/home/administrator/Geo_node_08SEP_25/geonode/uploaded/"
...
#MEDIA_URL="/home/administrator/Geo_node_08SEP_25/geonode/uploaded/"
LOCAL_MEDIA_URL = os.getenv("LOCAL_MEDIA_URL", f"{FORCE_SCRIPT_NAME}/{MEDIAFILES_LOCATION}/")
#LOCAL_MEDIA_URL="/home/administrator/Geo_node_08SEP_25/geonode/uploaded/"
...
MEMCACHED_LOCATION = os.getenv("MEMCACHED_LOCATION", "209.182.234.193:11211")
...
CACHES = {
    ...
    #     'LOCATION': '209.182.234.193:11211',
    # },
    # FILECACHE EXAMPLE
    # 'default': {
...
ACCESS_TOKEN_EXPIRE_SECONDS = int(os.getenv("ACCESS_TOKEN_EXPIRE_SECONDS", "9999999999999999999999999"))
...
#LOGIN_URL="http://209.182.234.193:8007/account/login/"
print("---------------LOGIN_URL-----------------",LOGIN_URL)
LOGOUT_URL = os.getenv("LOGOUT_URL", f"{SITEURL}account/logout/")

ACCOUNT_LOGIN_REDIRECT_URL = os.getenv("LOGIN_REDIRECT_URL", SITEURL)
#ACCOUNT_LOGIN_REDIRECT_URL="http://209.182.234.193:8007/account/login/"
print("ACCOUNT_LOGIN_REDIRECT_URLkkkkkkkkkkkkkkkkkk",ACCOUNT_LOGIN_REDIRECT_URL)
...
# GEOSERVER_PUBLIC_HOST = os.getenv("GEOSERVER_PUBLIC_HOST", '209.182.234.193')
...
GEOSERVER_PUBLIC_LOCATION = os.getenv("GEOSERVER_PUBLIC_LOCATION", 
                                     f"{GEOSERVER_PUBLIC_SCHEMA}://{GEOSERVER_PUBLIC_HOST}:{GEOSERVER_PUBLIC_PORT}/geoserver/")
...
#         "LOCATION": 'http://209.182.234.193:8080/geoserver/',
...
#         'GEOFENCE_ENABLED': False,  # 👈 Important
...
try:
    ...
    # fallback to regular list of values separated with misc chars
    ALLOWED_HOSTS = (
        [HOSTNAME, "localhost", "django", "geonode","127.0.0.1","http://geospace.coderize.in/","*"]
...
AUTH_IP_WHITELIST = (
    [HOSTNAME, "localhost", "django", "geonode","127.0.0.1"]
...
# PROXY_URL = os.environ.get("PROXY_URL", "http://geospace.coderize.in/")
...
ACCOUNT_AUTHENTICATION_METHOD = os.environ.get("ACCOUNT_AUTHENTICATION_METHOD", "username")
...
print("-----------------IMPORTER_HANDLERS-----------------------",IMPORTER_HANDLERS)
...
CSRF_TRUSTED_ORIGINS = [
    # "http://geospace.coderize.in/"
    #  "http://127.0.0.1:8000",
    # "http://209.182.234.193",
    "http://localhost:4200",
     "http://127.0.0.1:4200",
]
...
GEONODE_CLIENT_LAYER_ENABLE = True
