...
SITE_HOST_NAME = os.getenv("SITE_HOST_NAME", "209.182.234.193")
SITE_HOST_PORT = os.getenv("SITE_HOST_PORT", 8007)
_default_siteurl = (
...
SITEURL='http://209.182.234.193:8007/'
...
MIDDLEWARE = [
    ...
    "django.contrib.sessions.middleware.SessionMiddleware",
    "django.middleware.common.CommonMiddleware",
    #"django.middleware.csrf.CsrfViewMiddleware",  # must be here (after sessions)
    "django.contrib.auth.middleware.AuthenticationMiddleware",
    "django.contrib.messages.middleware.MessageMiddleware",
    "django.contrib.sites.middleware.CurrentSiteMiddleware",
    "dj_pagination.middleware.PaginationMiddleware",
...
GEOSERVER_PUBLIC_HOST = os.getenv("GEOSERVER_PUBLIC_HOST", 'http://209.182.234.193:8080/geoserver/')
...
GEOSERVER_PUBLIC_LOCATION = os.getenv("GEOSERVER_PUBLIC_LOCATION", 'http://209.182.234.193:8080/geoserver/')

GEOSERVER_WEB_UI_LOCATION = os.getenv("GEOSERVER_WEB_UI_LOCATION",'http://209.182.234.193:8080/geoserver/')
...
OGC_SERVER = {
    "default": {
        ...
        "PUBLIC_LOCATION": 'http://209.182.234.193:8080/geoserver/',
         "USER": "admin",
        "PASSWORD": "geoserver",
...
CATALOGUE = {
    "default": {
        ...
        "URL": os.getenv("CATALOGUE_URL", urljoin(SITEURL, "http://209.182.234.193:8080/catalogue/csw")),
...
try:
    ...
    # fallback to regular list of values separated with misc chars
    ALLOWED_HOSTS = (
        [HOSTNAME, "localhost", "django", "geonode","209.182.234.193"]
...
if USE_GEOSERVER:
    ...
    LOCAL_GEOSERVER = {
        "source": {
            ...
            "attribution": "&copy; http://209.182.234.193:8080/geoserver/web/",
            "ptype": LOCAL_GXP_PTYPE,
            "url": "/gs/ows",
            "restUrl": "/gs/rest",
        }
...
GEODATABASE_URL = "postgis://postgres:postgres@localhost:5432/geonode"
