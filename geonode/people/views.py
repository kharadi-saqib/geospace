...
def api_login(request):
    ...
    if not user.is_active:
        return JsonResponse({'status': 'error', 'message': 'User inactive'}, status=403)
...
# def api_register(request):
#     """
#     GeoNode-style JSON registration for Angular.
#     Accepts:
#     {
#         "username": "...",
#         "email": "...",
...
#     # Create user using GeoNode custom model
#     try:
#         user = User.objects.create_user(
#             username=username,
#             email=email,
...
#     # Auto-login (optional but smooth)
#     login(request, user)
